...
eosplace=`echo "DATASET_WORKDIR" | sed 's/\/afs\/cern.ch\/work\/j\/jtsai\/myAna\/bpTobH\/BprimeTobHSampleFilter\/CMSSW_5_3_13_patch3_GeneralSkim\/src\/BpbH\/BackgroundEstimationSkim\/test\/OnLxplus\///g'`
