...
eosplace=`echo "DATASET_WORKDIR" | sed 's/\/afs\/cern.ch\/work\/j\/jtsai\/myAna\/bpTobH\/BpbHDevel\/CMSSW_5_3_8_patch3_skim\/src\/BpbH\/BackgroundEstimationSkim\/test\/OnLxplus\///g'`
